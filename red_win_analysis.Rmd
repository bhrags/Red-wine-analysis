...
# Load the data
setwd('C:/Users/BHRAGS/Downloads')
...
Yup i found the relationship between free sulfur dioxide and total sulfurdioxide which were not main part of my research
...
From the sulphates vs.alcohol plot which was coloured by quality we can observe that best quality redwines tend to have high concentrations of sulphates and alcohol% .
...
above 13% - Trends seem to be different as we epproach above 13% mark.The correlation diminish rather become negative
we can observe that as alcohol % increased the overall quality pf the redwine increases.
------
